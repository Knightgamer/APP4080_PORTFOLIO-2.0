  ...
  const ProfileCard = () => {
        ...
        try {
          ...
          if (response.ok) {
            ...
            setFormData((prevData) => ({
              ...prevData,
              githubUsername: data.login || "", // Assuming 'login' is the GitHub username
            }));
          } else {
    ...
    //         const githubUsername = docSnap.data().githubUsername;
    //         if (githubUsername) {
      ...
      const fetchGitHubData = async (accessToken) => {
        try {
          ...
          if (response.ok) {
            ...
            // Update formData.githubUsername only when data is available
            setFormData((prevData) => ({
              ...prevData,
